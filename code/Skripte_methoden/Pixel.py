    ...
    while currpos_length <= length-1:
        ...
        while currpos_wide <= wide-1:
            ...
            if zielfarberotmin < rot < zielfarberotmax and zielfarbegrunmin < grun < zielfarbegrunmax and zielfarbeblaumin < blau < zielfarbeblaumax:
                ...
                while (z1 <= currpos_length+60) and (z1 < length): # Prueft ob in den naechsten 60 Pixeln 30 Treffer sind
                    farbe = pix[z1,z2]
                    rot = farbe[0]
                    grun= farbe[1]
                    blau = farbe[2]
                    ...
                    z1=z1+1
                while (z2 < currpos_wide+60) and (z2 < wide):  #Prueft ob in den naechsten 80 Pixeln vertikel 40 Treffer sind.
                    farbe = pix[z1,z2]
                    rot = farbe[0]
                    grun= farbe[1]
                    blau = farbe[2]
